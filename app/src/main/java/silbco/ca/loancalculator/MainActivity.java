...
public class MainActivity extends AppCompatActivity {
    ...
    private double getTotalInterest(double loanAmount, double totalLoan) {

        return totalLoan - loanAmount;
    }

    private double getTotalPayment(int termOfLoan, double monthlyPayment) {
        return monthlyPayment * termOfLoan * 12;
    }

    private double getMonthlyPayment(int termOfLoan, double yearlyInterestRate, double loanAmount) {
